...
const CHUMBA_CONTRACT_FIELDS: ContractField[] = [
  ...
  { id: 'tenant_nationality',  label: 'Utaifa wa Mpangaji',                type: 'text',      required: true,  placeholder: 'Tanzania / Nchi nyingine' },
  ...
  { id: 'guarantor_nationality',label:'Utaifa wa Mdhamini',               type: 'text',      required: false, placeholder: 'Tanzania / Nchi nyingine' },
