  ...
  return (
    <div style={pageStyle}>
      <section style={panelStyle}>
        ...
        <div style={{ ...metricGridStyle, marginTop: '22px' }}>
          <div style={metricCardStyle}>
            <div style={{ color: '#9f9587', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.14em' }}>Commission records</div>
            <div style={{ fontSize: '30px', marginTop: '8px' }}>{commissions.length}</div>
          </div>
          <div style={metricCardStyle}>
            <div style={{ color: '#9f9587', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.14em' }}>Total commissions</div>
      ...
      <section style={panelStyle}>
        ...
        {loading ? (
          <div style={{ color: '#9f9587' }}>Loading commission reports...</div>
        ) : commissions.length === 0 ? (
          <div style={{ color: '#9f9587' }}>No commission records found.</div>
        ) : (
                ...
                {commissions.map((item) => (
                  <tr key={item.id}>
                    <td style={tdStyle}>
                      ...
                      <div style={{ color: '#9f9587', marginTop: '4px' }}>{item.agent?.email || 'No email'}</div>
                    </td>
