      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .rg-left-bg {
          ...
          background:
            radial-gradient(ellipse 70% 60% at 30% 30%, rgba(201,168,76,0.08) 0%, transparent 55%),
            radial-gradient(ellipse 50% 60% at 80% 80%, rgba(201,168,76,0.05) 0%, transparent 50%),
        ...
        .rg-step-circle.done {
          background: rgba(112,196,144,0.15);
          border-color: rgba(112,196,144,0.4);
          color: var(--success);
        }
        ...
        @media (max-width: 480px) {
          ...
          .rg-user-types { grid-template-columns: 1fr; }
          .rg-pw-reqs { grid-template-columns: 1fr; }
        }
      `}</style>
      ...
      <div className="rg-left">
        ...
        <div className="rg-left-content">
          ...
          <h2 className="rg-left-title">
            Tanzania's<br /><em>Trusted</em><br />Rental Platform
          </h2>
        ...
        <div className="rg-panel">
          ...
          <div className="rg-progress">
            <div className="rg-step">
              <div className={`rg-step-circle${step === 1 ? ' active' : step > 1 ? ' done' : ''}`}>
                {step > 1 ? '✓' : '1'}
              </div>
          ...
          {step === 2 && (
            <>
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="rg-pw-strength">
                    <div className="rg-strength-bar">
                      {[0,1,2,3].map(i => (
                        <div
                          key={i}
                          className={`rg-strength-seg${i < pwStrength ? ` lit-${pwStrength}` : ''}`}
                        />
                      ))}
                    </div>
                ...
                {/* Terms */}
                <div className="rg-terms" style={{ marginTop: formData.password ? 0 : 0 }}>
                  <div
