...
.toast{
  ...
  box-shadow:0 8px 32px rgba(0,0,0,.12),0 2px 8px rgba(0,0,0,.06),inset 0 0 0 1px rgba(0,0,0,.06);
...
.toast-progress-bar{height:100%;border-radius:0 0 0 0;animation:toastProgress linear forwards;}
...
.m-close{
  ...
  border-radius:9px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.15);
...
.auth-hero{
  background:linear-gradient(135deg,var(--navy) 0%,#0f2744 100%);
  border-radius:20px 20px 0 0;padding:34px 28px 28px;text-align:center;position:relative;overflow:hidden;
}
.auth-hero::before{
...
.auth-hero::after{
  ...
  border-radius:50%;background:rgba(201,168,76,.05);pointer-events:none;
}
.auth-hero-icon{
  width:58px;height:58px;border-radius:17px;
  background:rgba(201,168,76,.15);border:1px solid rgba(201,168,76,.28);
...
.auth-prop-pill{
  ...
  font-family:var(--sans);font-size:12px;color:rgba(255,255,255,.55);
  position:relative;z-index:1;
}
.auth-prop-pill strong{color:#fff;font-weight:500;}
.auth-opt{
  display:flex;align-items:center;gap:14px;
  padding:15px 16px;border:1px solid var(--border);border-radius:12px;
  cursor:pointer;transition:all .22s;margin-bottom:10px;background:var(--surface);
  position:relative;overflow:hidden;
}
.auth-opt::before{
...
/* ── Prop Info Card ── */
.prop-info{
  background:linear-gradient(135deg,var(--bg) 0%,#EFF4FF 100%);
...
.prop-info::after{
  ...
  border-radius:50%;background:rgba(30,58,95,.04);pointer-events:none;
}
...
.pay-secure{
  ...
  font-family:var(--sans);font-size:12px;color:var(--success);
}
.pay-input{
...
.confirm-icon-wrap{
  padding:30px 28px 18px;text-align:center;
}
.confirm-icon{
...
.confirm-btn.primary.warning:hover{background:#b45309;border-color:#b45309;box-shadow:0 4px 14px rgba(217,119,6,.3);}
.confirm-btn.primary.info{background:var(--info);border-color:var(--info);}
.confirm-btn.primary.info:hover{background:#0369a1;border-color:#0369a1;box-shadow:0 4px 14px rgba(2,132,199,.3);}
