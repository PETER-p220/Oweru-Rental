...
class AdminController extends Controller
{
    ...
    public function createUser(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'user_type' => 'required|in:tenant,landlord,agent,admin,bnb_owner,commercial',
    ...
    public function updateUser(Request $request, $userId): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'user_type' => 'sometimes|required|in:tenant,landlord,agent,admin,bnb_owner,commercial',
