// ============================================================
// LANDLORD THEME — matches tenant/homepage color palette
...
/// Gold pill label e.g.  "LANDLORD PORTAL"
class LLabel extends StatelessWidget {
  final String text;
  const LLabel(this.text, {super.key});
  @override
...
/// Gold action button
class LGoldButton extends StatelessWidget {
  final String label;
  final VoidCallback? onTap;
  final IconData? icon;
  final bool fullWidth;
  const LGoldButton({super.key, required this.label, this.onTap, this.icon, this.fullWidth = true});
  @override
