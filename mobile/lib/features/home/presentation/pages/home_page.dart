...
const String kStorageBase = 'https://api.oweru.com';
...
String fmtPrice(num price) {
  return 'TZS ${price.toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (m) => '${m[1]},')}';
}
...
String getImage(Map<String, dynamic> p) {
  ...
  if (imgs is List && imgs.isNotEmpty) {
    ...
    if (first is String && first.trim().isNotEmpty) {
      return resolveStoragePath(first);
    }
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _heroAnim = AnimationController(
      ...
      ..repeat(reverse: true);
    _heroScale = Tween(begin: 1.02, end: 1.08).animate(
                      ...
                      : Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(flex: 9, child: _buildSearchCard()),
                            ],
                          ),
                        ),
                ),
  ...
  Widget _buildHeroLeft() {
    return Column(
      ...
      children: [
        ...
        const Text(
          'Connect with trusted landlords and professional agents across Tanzania. Residential, commercial, and short-stay all in one place.',
          style: TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w300,
              height: 1.75,
              color: Color(0x8CF1F5F9),
              fontFamily: 'Outfit'),
        ),
  ...
  Widget _buildSearchCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(color: Color(0x800A0F1E), blurRadius: 80, offset: Offset(0, 40))
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Color(0x4DC89128), blurRadius: 16)
                  ],
                ),
                child: const Icon(Icons.search, color: kBg, size: 18),
              ),
              ...
              const Column(
                ...
                children: [
                  ...
                  Text('Find residential, commercial & more',
                      style: TextStyle(
                          fontSize: 12, color: kSlate, fontFamily: 'Outfit')),
                ],
              ),
            ],
          ),
          ...
          _SearchInput(
            ...
            onSubmit: () => setState(() => _searchActive = true),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x40C89128), blurRadius: 16, offset: Offset(0, 4))
          ],
        ),
        child: const Row(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Container(width: 1, height: 52, color: kBorder),
                ...
                children: [
                  Text('All Listings',
                      style: TextStyle(
                          ...
                          fontFamily: 'Outfit')),
                  SizedBox(width: 6),
                  Icon(Icons.arrow_forward, size: 12, color: kBg),
                ],
              ),
            ),
          ),
  ...
  Widget _buildEmptySearch() {
    return Center(
      child: Padding(
        ...
        child: Column(
          children: [
            const Icon(Icons.search, size: 40, color: Color(0x66C89128)),
            const SizedBox(height: 16),
            const Text('No properties found',
                style: TextStyle(
                    fontSize: 20, color: kCream, fontFamily: 'Outfit')),
            const SizedBox(height: 8),
            const Text('Try a different location or adjust your filters.',
                style: TextStyle(
                    fontSize: 14, color: kSlate, fontFamily: 'Outfit')),
  ...
  // ── SECTIONS ──────────────────────────────────────────────────────────────
  Widget _buildResidentialSection() {
    return _Section(
      id: 'residential',
      bgColor: kBg,
      tag: '🏠 Residential',
  ...
  Widget _buildBnbGrid() {
    return LayoutBuilder(builder: (ctx, constraints) {
      final cols = constraints.maxWidth > 600 ? 3 : 1;
      final itemW = (constraints.maxWidth - (cols - 1) * 20) / cols;
      return Wrap(
        spacing: 20,
        runSpacing: 20,
        children: _bnb.map((p) {
  ...
  Widget _buildOweruSection() {
    return _Section(
      id: 'oweru',
      bgColor: kBg,
      tag: '🛡️ Exclusive Offers',
      title: 'Oweru ',
      titleEm: 'Special Packages',
      child: _loadingOweru
          ? const _SkeletonGrid()
          : _oweru.isEmpty
      ...
      child: LayoutBuilder(builder: (ctx, constraints) {
        ...
        return Row(
          children: [
            ...
            Expanded(child: _ctaRight(items)),
          ],
        );
      }),
    );
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          ...
          style: TextStyle(
              fontSize: 14, color: kSlate, height: 1.7, fontFamily: 'Outfit'),
        ),
        const SizedBox(height: 32),
        _GoldButton(
  ...
  Widget _ctaRight(List<String> items) {
    return Column(
      children: items
          .map((item) => Container(
  ...
  // ── Property Grid ─────────────────────────────────────────────────────────
  Widget _buildPropGrid(List<Map<String, dynamic>> items,
      {bool isCommercial = false, String? badge}) {
    return LayoutBuilder(builder: (ctx, constraints) {
...
class _SearchInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: const TextStyle(
          color: kCream, fontSize: 13, fontFamily: 'Outfit'),
      onSubmitted: (_) => onSubmit(),
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: const TextStyle(color: kSlateDim, fontSize: 13),
        filled: true,
        fillColor: const Color(0xCC0A0F1E),
        contentPadding:
        ...
        suffixIcon: ValueListenableBuilder(
          ...
          builder: (_, val, __) => val.text.isNotEmpty
              ? IconButton(
                  icon: const Icon(Icons.close, size: 13, color: kSlate),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on, size: 11, color: kGold),
...
class _CommCard extends StatelessWidget {
  ...
  static const _typeColors = {
    'office': Color(0xFF22D3EE),
    'retail': Color(0xFFF472B6),
    'warehouse': Color(0xFFFB923C),
    'commercial': Color(0xFFA78BFA),
  ...
  Widget build(BuildContext context) {
    ...
    final price = num.tryParse(p['price']?.toString() ?? '0') ?? 0;
    final priceType = p['price_type']?.toString() ?? '';
    final sfx = priceType == 'yearly'
        ? '/yr'
        : priceType == 'sale'
            ? ''
            : '/mo';
                ...
                children: [
                  SizedBox(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (_, __, ___) => Container(
                        color: kBg2,
                        child: const Center(
                          child: Icon(Icons.business, color: kGold, size: 40),
                        ),
                      ),
                    ),
                  ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        commercialTypeLabel(p['type']).toUpperCase(),
                        style: TextStyle(
                            fontSize: 9,
                            fontWeight: FontWeight.w700,
                            letterSpacing: 0.12,
                ...
                children: [
                  ...
                  if (p['area'] != null ||
                    ...
                    Wrap(
                      ...
                      children: [
                        if (p['area'] != null)
                          _FeatTag(label: '${p['area']} m²'),
                        if ((p['parking_spaces'] ?? 0) > 0)
                          _FeatTag(
                              label: '${p['parking_spaces']} Parking'),
                        if (p['furnished'] == true)
                          _FeatTag(
                              label: 'Furnished',
...
class _SkeletonGridState extends State<_SkeletonGrid>
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (ctx, constraints) {
      ...
      final itemW = (constraints.maxWidth - (cols - 1) * 20) / cols;
      return FadeTransition(
        opacity: Tween(begin: 0.5, end: 0.9).animate(_ctrl),
        child: Wrap(
          spacing: 20,
          runSpacing: 20,
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        ...
        child: Column(
          children: [
            const Icon(Icons.business, size: 40, color: Color(0x59C89128)),
            const SizedBox(height: 16),
            Text(text,
                style: const TextStyle(
                    fontSize: 18, color: kCream, fontFamily: 'Outfit')),
          ],
        ),
      ),
    );
...
class _BookingFormState extends State<_BookingForm> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final price =
          num.tryParse(widget.property['price']?.toString() ?? '0') ?? 0;
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text(
                  'Booking submitted! The owner will contact you soon.')));
        }
      } else {
  ...
  Future<DateTime?> _pickDate(DateTime first) {
          ...
          children: [
            ...
            Expanded(
              child: _datePicker('Check-out', _checkOut, () async {
                final d =
                    await _pickDate(_checkIn ?? DateTime.now());
